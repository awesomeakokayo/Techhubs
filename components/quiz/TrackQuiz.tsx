...
const QUESTIONS = [
  ...
  },
  {
    q: "What's your goal?",
    options: [
      { label: 'Get a job at a tech company', scores: { frontend: 2, backend: 2, fullstack: 2, data: 1, crypto: 1 } },
      { label: 'Build my own products', scores: { fullstack: 3, python: 2, nocode: 2, crypto: 2 } },
