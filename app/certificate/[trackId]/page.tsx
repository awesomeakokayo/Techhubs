    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          .certificate-course { font-size: 22pt !important; }
          .certificate-date { font-size: 11pt !important; }
        }
      `}</style>
                ...
                <>
                  ...
                  <div className="mt-10 flex items-end justify-between text-left">
                    <div className="border-t border-border-default pt-2">
                      <p className="text-xs text-text-muted">Issued by</p>
                    ...
                    <div className="border-t border-border-default pt-2 text-right">
                      <p className="text-xs text-text-muted">Credential</p>
                      <p className="mt-1 font-display text-sm font-semibold text-text-primary">Course completion</p>
                    </div>
                  </div>
                </>
              ) : (
